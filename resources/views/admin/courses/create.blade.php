...
@section('content')
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            @if($errors->any())
            <div class="flex items-center gap-5 p-[20px_30px] bg-[#FDE7E7] border border-[#FECACA] rounded-[14px]">
                <div class="w-[24px] h-[24px] flex items-center justify-center">
                    <img src="{{ asset('assets/images/icons/alert-circle.svg') }}" alt="icon">
                </div>
                <div class="flex flex-col gap-1">
                    <p class="font-semibold text-[#FECACA]">Error</p>
                    <ul class="list-disc text-[#FECACA]">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('dashboard.courses.store') }}"
                ...
                <div class="group/category flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <select id="category"
                            class="pl-1 font-semibold focus:outline-none w-full text-[#0A090B] invalid:text-[#7F8190] invalid:font-normal appearance-none bg-[url('assets/images/icons/arrow-down.svg')] bg-no-repeat bg-right"
